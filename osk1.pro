...
UBUNTU_TRANSLATION_DOMAIN="osk1.liu-xiao-guo"
...
aptest.commands = bash $$PWD/osk1/tests/autopilot/run
aptest.depends  = sub-osk1

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/osk1/tests/unit
unittest.depends  = sub-osk1
